// modules/search-unified/infrastructure/providers/EmbySearchProviderAdapter.ts — CE8-C1
// Bridges Emby IMediaServer → ISearchProviderPort.
...
export class EmbySearchProviderAdapter implements ISearchProviderPort {
