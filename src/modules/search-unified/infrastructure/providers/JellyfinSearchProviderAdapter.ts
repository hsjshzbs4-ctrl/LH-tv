// modules/search-unified/infrastructure/providers/JellyfinSearchProviderAdapter.ts — CE8-C1
// Bridges Jellyfin IMediaServer → ISearchProviderPort.
...
export class JellyfinSearchProviderAdapter implements ISearchProviderPort {
