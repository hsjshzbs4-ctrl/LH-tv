// modules/recommendation/infrastructure/providers/EmbyRecommendationAdapter.ts — CE9-D
// Adapts Emby media server data into IRecommendationProvider.
...
export class EmbyRecommendationAdapter implements IRecommendationProvider {
  readonly name = 'emby-recommendation'
